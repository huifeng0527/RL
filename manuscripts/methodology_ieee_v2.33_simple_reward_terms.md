# methodology_ieee_v2.33_simple_reward_terms

Stage manuscript draft revised from `methodology_ieee_v2.32_problem_reward_prose_revision.md`. This version further simplifies the reward formulation into four intuitive terms: distance regulation, action smoothness, workspace-boundary safety, and catch avoidance.
