# methodology_ieee_v2.41_league_section_rewrite

Stage manuscript draft revised from `methodology_ieee_v2.40_no_cmd_dr_spc_symbol_polish.md`. This version rewrites the league-training results section, corrects the Fig. 3 caption to match the actual two-panel figure, and updates the figure labels to TIZ.
