# TBME LaTeX project — manuscript v2.94

This project synchronizes `manuscripts_methodology_v2.93_prioritized_opponent_sampling.docx` with the full-paper LaTeX template from:
