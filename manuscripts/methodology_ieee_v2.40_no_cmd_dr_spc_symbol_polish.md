# methodology_ieee_v2.40_no_cmd_dr_spc_symbol_polish

Stage manuscript draft revised from `methodology_ieee_v2.39_formula_table_caption_polish.md`. This version removes the domain-randomization abbreviation, clarifies reward-term prose, and standardizes stochastic scripted pursuit-controller notation.
