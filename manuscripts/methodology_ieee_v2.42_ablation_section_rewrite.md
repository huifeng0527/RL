# methodology_ieee_v2.42_ablation_section_rewrite

Stage manuscript draft revised from `methodology_ieee_v2.41_league_section_rewrite.md`. This version rewrites the network-ablation results section and standardizes the Fig. 4 caption to match the actual four-panel figure.
