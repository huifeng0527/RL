...
panel(rx, ty, pw, ph, "b", "Policy and league learning")
...
# b) Policy and league learning.
px, py = rx, ty
box(px + 0.037, py + 0.090, 0.170, 0.200, fc=C["blue_l"], ec=C["blue"], lw=1.0)
txt(px + 0.122, py + 0.267, "adaptive robot policy", size=7.2, weight="bold", color=C["blue"])
box(px + 0.055, py + 0.213, 0.060, 0.040, "scalar\nMLP", fc="white", ec=C["blue"], size=5.9)
box(px + 0.130, py + 0.213, 0.060, 0.040, "history\nGRU", fc="white", ec=C["blue"], size=5.9)
box(px + 0.077, py + 0.145, 0.090, 0.040, "fusion", fc="white", ec=C["blue"], size=6.2)
box(px + 0.077, py + 0.100, 0.090, 0.032, "action head", fc="white", ec=C["blue"], size=5.9)
box(px + 0.040, py + 0.045, 0.164, 0.032, "aux. future-dynamics head", fc="#FAFAFA", ec=C["blue"], size=5.9, ls=(0, (3, 2)))
arrow(px + 0.085, py + 0.213, px + 0.102, py + 0.185, color=C["blue"], lw=0.8, ms=6)
arrow(px + 0.160, py + 0.213, px + 0.142, py + 0.185, color=C["blue"], lw=0.8, ms=6)
arrow(px + 0.122, py + 0.145, px + 0.122, py + 0.132, color=C["blue"], lw=0.8, ms=6)
box(px + 0.245, py + 0.235, 0.120, 0.050, "hand pool\n$H_1 \ldots H_k$ + SPC", fc=C["orange_l"], ec=C["orange"], size=6.2)
box(px + 0.245, py + 0.165, 0.120, 0.045, "PFSP sampler", fc=C["purple_l"], ec=C["purple"], size=6.6)
box(px + 0.245, py + 0.095, 0.120, 0.045, "PPO update", fc=C["green_l"], ec=C["green"], size=6.6)
box(px + 0.245, py + 0.030, 0.120, 0.040, "next robot", fc="white", ec=C["green"], size=6.2)
arrow(px + 0.245, py + 0.260, px + 0.207, py + 0.245, color=C["orange"], lw=0.9, ms=7)
arrow(px + 0.245, py + 0.187, px + 0.207, py + 0.185, color=C["purple"], lw=0.9, ms=7)
arrow(px + 0.245, py + 0.118, px + 0.207, py + 0.120, color=C["green"], lw=0.9, ms=7)
arrow(px + 0.305, py + 0.095, px + 0.305, py + 0.070, color=C["green"], lw=0.8, ms=6)
...
for path in [
    OUT_DIR / "fig_overview_system_framework_orthogonal_v4.png",
    DRAFT_DIR / "fig_overview_system_framework_orthogonal_v4_draft.png",
]:
    fig.savefig(path, dpi=450, bbox_inches="tight", pad_inches=0.035, facecolor="white")
fig.savefig(OUT_DIR / "fig_overview_system_framework_orthogonal_v4.pdf", bbox_inches="tight", pad_inches=0.035, facecolor="white")
fig.savefig(OUT_DIR / "fig_overview_system_framework_orthogonal_v4.svg", bbox_inches="tight", pad_inches=0.035, facecolor="white")
plt.close(fig)

print((OUT_DIR / "fig_overview_system_framework_orthogonal_v4.png").as_posix())
print((OUT_DIR / "fig_overview_system_framework_orthogonal_v4.pdf").as_posix())
print((OUT_DIR / "fig_overview_system_framework_orthogonal_v4.svg").as_posix())
print((DRAFT_DIR / "fig_overview_system_framework_orthogonal_v4_draft.png").as_posix())
